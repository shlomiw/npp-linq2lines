...
namespace NppPluginNET
{
    ...
    public class Win32
    {
        ...
        /* shlomi - not tested
        [DllImport("kernel32")]
        public static extern int GetPrivateProfileString(string lpAppName, string lpKeyName, string lpDefault, [MarshalAs(UnmanagedType.LPStr)] StringBuilder lpReturnedString, int nSize, string lpFileName);
         * */
        [DllImport("kernel32")]
